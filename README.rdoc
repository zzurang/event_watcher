...
== DESCRIPTION:
Flexible minitoring tool for logging method call and callback events
...
EventWatcher.setup do  
  ...
  callback_watcher(:Subscriber, :after_create) do |klass, params, result|
    puts <<-LOG
  ...
  method_call_watcher(:Subscriber, :create) do |object, params, result|    
    puts <<-LOG
